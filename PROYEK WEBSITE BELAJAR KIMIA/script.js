document.addEventListener('DOMContentLoaded', () => {
    ...
    const navGlossary = document.getElementById('nav-glossary'); // <-- BARU
    ...
    const glossaryView = document.getElementById('glossary-view'); // <-- BARU
    ...
    function generatePhScale() {
        ...
        // ▼▼▼ DIMODIFIKASI: Hapus properti 't' (text color) ▼▼▼
        const phData = [
        ...
        phData.forEach(item => {
            ...
            // ▼▼▼ DIMODIFIKASI: Hapus logika class 'light-text'/'dark-text' ▼▼▼
    ...
    // ▼▼▼ BARU: Event listener untuk nav Istilah Kimia ▼▼▼
