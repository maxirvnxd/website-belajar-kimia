...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Kita simpan semua data fun fact dalam satu array
    const funFactsData = [
        {
            id: 'takut',
        ...
        },
        {
            ...
            content: `
                ...
                <h3>Elektronik (Papan Sirkuit):</h3>
    ...
    const navFunFact = document.getElementById('nav-fun-fact'); // <-- BARU
    ...
    const funFactListView = document.getElementById('fun-fact-list-view'); // <-- BARU
    const funFactDetailView = document.getElementById('fun-fact-detail-view'); // <-- BARU
    ...
    const funFactGrid = document.getElementById('fun-fact-grid'); // <-- BARU
    const funFactDetailHeader = document.getElementById('fun-fact-detail-header'); // <-- BARU
    const funFactDetailContent = document.getElementById('fun-fact-detail-content'); // <-- BARU
    ...
    function handleLogin(event) {
        ...
        if (validUsers[username] && validUsers[username] === password) {
            ...
            // ▼▼▼ DIMODIFIKASI: Ubah durasi ke 2900 ms (2.9 detik) ▼▼▼
            setTimeout(() => {
    ...
    /**
     * Fungsi untuk membuat Skala pH Interaktif (Tidak berubah)
     */
    function generatePhScale() {
        ...
        const phData = [
            ...
            { p: 7, c: '#15803d', t: 'light', ex: 'Air Murni (Netral)' },
     ...
     * @param {number} index - Index dari fun fact di array funFactsData
     */
    function showFunFactDetail(index) {
        ...
        // Isi konten penjelasan
        // Kita tambahkan judul h2 di atas konten yang sudah kita siapkan
    ...
    // ▼▼▼ BARU: Event listener untuk nav Fun-Fact ▼▼▼
    ...
    // Tombol "Kembali" (sekarang bekerja untuk semua tombol .btn-back)
    ...
    generatePhScale();
    generateFunFactCards(); // <-- BARU: Buat kartu fun fact saat memuat
});